...
const testimonials: Testimonial[] = [
  ...
  {
    id: 3,
    content: "Growmodo really helped us keep accurate control over our budget and get a fantastically designed website in the process. I highly recommend not just their talents, but this model.",
    author: "Sean Boyce",
    role: "Founder",
    company: "StaffGeek"
  },
  {
    id: 4,
    content: "Working with Growmodo has been a game-changer for our agency. Their team's responsiveness and quality of work allow us to deliver better results to our clients.",
