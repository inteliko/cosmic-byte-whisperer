    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none mb-8">
          <p>
            Control how Growmodo processes your data and which cookies we can use. These settings allow
          ...
          <Collapsible className="bg-gray-50 p-6 rounded-lg border">
            ...
            <CollapsibleContent className="mt-4">
              <div className="space-y-4 text-gray-700">
                <p>
                  At Growmodo, we take your data privacy seriously. Here's additional information about how
