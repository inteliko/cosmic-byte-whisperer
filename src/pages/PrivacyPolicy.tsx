    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="lead">
            At Growmodo, we take your privacy seriously. This Privacy Policy explains how we collect, use,
          ...
          <p>
            Growmodo has the discretion to update this privacy policy at any time. When we do, we will revise
