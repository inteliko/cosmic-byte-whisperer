    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Growmodo is a registered trademark of Growmodo, Inc. All content on this website, including
            text, graphics, logos, images, audio clips, and software, is the property of Growmodo, Inc.
