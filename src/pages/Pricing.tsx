  ...
  const faqItems = [
    {
      ...
      answer: "Growmodo is a design & development subscription service for growing agencies, marketing teams, and scale-ups that allows you to access various design and coding skills and a dedicated project manager at a flat monthly rate. We allow you to scale your design & dev operations fast without the hassle of traditional employment (recruiting, HR, Admin & talent development) or individual freelancers from marketplaces."
    },
    {
        ...
        <section className="py-16 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center mb-12 text-lg">
              Growmodo makes outsourcing design and development tasks a no-brainer by<br />
